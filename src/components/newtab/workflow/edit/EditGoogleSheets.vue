<template>
  <div class="mb-10">
    ...
    >
      ...
      >
        <template #label>
          ...
          <a
            href="https://docs.turium.site/blocks/google-sheets.html#spreadsheet-id"
            target="_blank"
            rel="noopener"
    ...
    <a
      ...
      href="https://docs.turium.site/blocks/google-sheets.html#access-to-spreadsheet"
      target="_blank"
      rel="noopener"
    ...
    <edit-autocomplete v-if="!['create', 'add-sheet'].includes(data.type)">
      ...
      >
        <template #label>
          ...
          <a
            href="https://docs.turium.site/blocks/google-sheets.html#range"
            target="_blank"
            rel="noopener"

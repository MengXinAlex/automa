          ...
          <div v-if="currentLog.status === 'error' && errorBlock">
            <p class="line-clamp leading-tight">
              ...
              <a
                ...
                :href="`https://docs.turium.site/reference/workflow-common-errors.html#${errorBlock.messageId}`"
                target="_blank"
          ...
          <div class="w-full space-y-1 overflow-auto font-mono text-sm">
            ...
            >
              ...
              >
                ...
                <a
                  v-if="item.messageId"
                  :href="`https://docs.turium.site/reference/workflow-common-errors.html#${item.messageId}`"
                  target="_blank"
                  title="About the error"
                  @click.stop
                >
